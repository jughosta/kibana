...
import { MultiGroupReorderProvider } from '@kbn/dom-drag-drop';
...
const GROUPS = Object.values(FieldsGroupNames);
...
function InnerFieldListGrouped<T extends FieldListItem = DataViewField>({
  ...
  return (
    <MultiGroupReorderProvider draggingHeight={24} groupIds={GROUPS}>
      <div
            ...
            return (
              <Fragment key={key}>
                <FieldsAccordion<T>
                  ...
                  canReorderItems={fieldGroup.canReorderItems}
